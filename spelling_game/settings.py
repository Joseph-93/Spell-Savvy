"""
Django settings for spelling_game project.
...
CSRF_TRUSTED_ORIGINS = ["https://eduflows.org"]
...
ROOT_URLCONF = "spelling_game.urls"
...
WSGI_APPLICATION = "spelling_game.wsgi.application"
